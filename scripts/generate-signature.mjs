 ...
 */
const LOGO = { file: 'email-logo.png', width: 210, height: 39 };
  ...
  <tr>
    ...
    <td style="padding:14px 0 0 0;border-top:1px solid ${palette.hair}">
      <!-- width and height as attributes as well as in the style: Outlook
           ...
           full 420px. -->
      <a href="${origin}" style="text-decoration:none"><img src="${origin}/${LOGO.file}" width="${LOGO.width}" height="${LOGO.height}" alt="Faviens" style="display:block;width:${LOGO.width}px;height:${LOGO.height}px;border:0;outline:none;text-decoration:none"></a>
    </td>
  </tr>
  <tr>
